...
impl Plugin for SpacePlugin {
    fn build(&self, app: &mut App) {
        ...
        app.insert_resource(scene::pinned_docs::PinChanges(
            state::replicas::register_pin_stream(),
        ))
        ...
        .add_systems(
            ...
            (
                ...
                scene::pinned_docs::apply_pin_changes,
                scene::pinned_docs::fetch_pinned_docs,
                scene::pinned_docs::instantiate_pinned_docs,
                scene::pinned_docs::despawn_unpinned_docs,
            ),
        )
        .add_systems(
            Update,
