...
impl Plugin for HsdPlugin {
    fn build(&self, app: &mut App) {
        app.register_asset_loader(asset::BlobLoader)
            ...
            .add_observer(hydrate::compile::create::handle_hsd_remove_material)
            .add_observer(hydrate::compile::create::handle_hsd_remove_mesh)
            .add_observer(hydrate::compile::create::handle_hsd_remove_node)
