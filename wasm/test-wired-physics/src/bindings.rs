...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.35.0:test:wired-physics:script:encoded world"]
#[doc(hidden)]
...
\x04\0\x12wired:script/types\x05\x1a\x04\0\x19test:wired-physics/script\x04\0\x0b\
