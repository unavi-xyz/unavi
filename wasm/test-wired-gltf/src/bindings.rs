...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 2182] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x89\x10\x01A\x02\x01\
...
\x04\x04\x01\x12wired:script/types\x05\x08\x04\x01\x16test:wired-gltf/script\x04\
