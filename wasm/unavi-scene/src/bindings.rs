            ...
            pub mod api {
                ...
                impl Scene {
                    ...
                    pub fn new<T: GuestScene>(val: T) -> Self {
                        ...
                        let ptr: *mut _SceneRep<T> = _rt::Box::into_raw(
                            _rt::Box::new(val),
                        );
                        unsafe { Self::from_handle(T::_resource_new(ptr.cast())) }
                    }
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_static_root_list_scenes<T: GuestRoot>(
                    arg0: *mut u8,
                ) {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_static_root_add_scene_cabi<T: GuestRoot>(
                    arg0: i32,
                ) {
                    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_static_root_remove_scene_cabi<T: GuestRoot>(
                    arg0: i32,
                ) {
                    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_method_scene_list_nodes<T: GuestScene>(
                    arg0: *mut u8,
                ) {
                    let l0 = *arg0.add(0).cast::<*mut u8>();
                    let l1 = *arg0.add(4).cast::<usize>();
