...
interface Props {
  selected: IEntity<"SpotLight">;
  handleChange: (key: string, value: any) => void;
}

export default function SpotLightMenu({ selected, handleChange }: Props) {
  ...
  const penumbra = selected.props.penumbra ?? 0;
