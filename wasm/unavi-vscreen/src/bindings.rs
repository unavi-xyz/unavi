    ...
    pub mod unavi {
        ...
        pub mod vscreen {
            ...
            pub mod screen {
                ...
                type _ScreenRep<T> = Option<T>;
                impl Screen {
                    /// Creates a new resource from the specified representation.
                    ///
                    /// This function will create a new resource handle by moving `val` onto
                    /// the heap and then passing that heap pointer to the component model to
                    /// create a handle. The owned handle is then returned as `Screen`.
                    pub fn new<T: GuestScreen>(val: T) -> Self {
                        Self::type_guard::<T>();
                        let val: _ScreenRep<T> = Some(val);
                        let ptr: *mut _ScreenRep<T> = _rt::Box::into_raw(
                            _rt::Box::new(val),
                        );
                        unsafe { Self::from_handle(T::_resource_new(ptr.cast())) }
                    }
                    /// Gets access to the underlying `T` which represents this resource.
                    pub fn get<T: GuestScreen>(&self) -> &T {
                        let ptr = unsafe { &*self.as_ptr::<T>() };
                        ptr.as_ref().unwrap()
                    }
                    /// Gets mutable access to the underlying `T` which represents this
                    /// resource.
                    pub fn get_mut<T: GuestScreen>(&mut self) -> &mut T {
                        let ptr = unsafe { &mut *self.as_ptr::<T>() };
                        ptr.as_mut().unwrap()
                    }
                    /// Consumes this resource and returns the underlying `T`.
                    pub fn into_inner<T: GuestScreen>(self) -> T {
                        let ptr = unsafe { &mut *self.as_ptr::<T>() };
                        ptr.take().unwrap()
                    }
                    #[doc(hidden)]
                    ...
                    pub unsafe fn dtor<T: 'static>(handle: *mut u8) {
                        Self::type_guard::<T>();
                        let _ = _rt::Box::from_raw(handle as *mut _ScreenRep<T>);
                    }
                    fn as_ptr<T: GuestScreen>(&self) -> *mut _ScreenRep<T> {
                        Screen::type_guard::<T>();
                        T::_resource_rep(self.handle()).cast()
                    }
                }
                /// A borrowed version of [`Screen`] which represents a borrowed value
                /// with the lifetime `'a`.
                #[derive(Debug)]
                #[repr(transparent)]
                pub struct ScreenBorrow<'a> {
                    rep: *mut u8,
                    _marker: core::marker::PhantomData<&'a Screen>,
                }
                impl<'a> ScreenBorrow<'a> {
                    #[doc(hidden)]
                    ...
                    fn as_ptr<T: 'static>(&self) -> *mut _ScreenRep<T> {
                        Screen::type_guard::<T>();
                        self.rep.cast()
                    }
                }
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_screen_root_cabi<T: GuestScreen>(
                    arg0: *mut u8,
                ) -> i32 {
                    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                    let result0 = T::root(
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_screen_set_visible_cabi<T: GuestScreen>(
                    arg0: *mut u8,
                    arg1: i32,
                ) {
                    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_screen_animation_duration_cabi<
                    T: GuestScreen,
                >(arg0: *mut u8) -> f32 {
                    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                    let result0 = T::animation_duration(
                        ScreenBorrow::lift(arg0 as u32 as usize).get(),
                    );
                    _rt::as_f32(result0)
                }
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_screen_set_animation_duration_cabi<
                    T: GuestScreen,
                >(arg0: *mut u8, arg1: f32) {
                    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                    T::set_animation_duration(
                        ScreenBorrow::lift(arg0 as u32 as usize).get(),
                        arg1,
                    );
                }
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_method_screen_children<T: GuestScreen>(
                    arg0: *mut u8,
                ) {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_screen_update_cabi<T: GuestScreen>(
                    arg0: *mut u8,
                    arg1: f32,
                ) {
                    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                ...
                #[doc(hidden)]
                macro_rules! __export_unavi_vscreen_screen_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "unavi:vscreen/screen#[constructor]screen"] unsafe extern "C" fn
                        export_constructor_screen(arg0 : i32, arg1 : f32, arg2 : f32,) ->
                        i32 { $($path_to_types)*:: _export_constructor_screen_cabi::<<$ty
                        as $($path_to_types)*:: Guest >::Screen > (arg0, arg1, arg2) }
                        #[export_name = "unavi:vscreen/screen#[method]screen.root"]
                        unsafe extern "C" fn export_method_screen_root(arg0 : * mut u8,)
                        -> i32 { $($path_to_types)*::
                        _export_method_screen_root_cabi::<<$ty as $($path_to_types)*::
                        Guest >::Screen > (arg0) } #[export_name =
                        "unavi:vscreen/screen#[method]screen.open"] unsafe extern "C" fn
                        export_method_screen_open(arg0 : * mut u8,) -> i32 {
                        $($path_to_types)*:: _export_method_screen_open_cabi::<<$ty as
                        $($path_to_types)*:: Guest >::Screen > (arg0) } #[export_name =
                        "unavi:vscreen/screen#[method]screen.set-open"] unsafe extern "C"
                        fn export_method_screen_set_open(arg0 : * mut u8, arg1 : i32,) {
                        $($path_to_types)*:: _export_method_screen_set_open_cabi::<<$ty
                        as $($path_to_types)*:: Guest >::Screen > (arg0, arg1) }
                        #[export_name = "unavi:vscreen/screen#[method]screen.visible"]
                        unsafe extern "C" fn export_method_screen_visible(arg0 : * mut
                        u8,) -> i32 { $($path_to_types)*::
                        _export_method_screen_visible_cabi::<<$ty as $($path_to_types)*::
                        Guest >::Screen > (arg0) } #[export_name =
                        "unavi:vscreen/screen#[method]screen.set-visible"] unsafe extern
                        "C" fn export_method_screen_set_visible(arg0 : * mut u8, arg1 :
                        i32,) { $($path_to_types)*::
                        _export_method_screen_set_visible_cabi::<<$ty as
                        $($path_to_types)*:: Guest >::Screen > (arg0, arg1) }
                        #[export_name =
                        "unavi:vscreen/screen#[method]screen.animation-duration"] unsafe
                        extern "C" fn export_method_screen_animation_duration(arg0 : *
                        mut u8,) -> f32 { $($path_to_types)*::
                        _export_method_screen_animation_duration_cabi::<<$ty as
                        $($path_to_types)*:: Guest >::Screen > (arg0) } #[export_name =
                        "unavi:vscreen/screen#[method]screen.set-animation-duration"]
                        unsafe extern "C" fn
                        export_method_screen_set_animation_duration(arg0 : * mut u8, arg1
                        : f32,) { $($path_to_types)*::
                        _export_method_screen_set_animation_duration_cabi::<<$ty as
                        $($path_to_types)*:: Guest >::Screen > (arg0, arg1) }
                        #[export_name = "unavi:vscreen/screen#[method]screen.children"]
                        unsafe extern "C" fn export_method_screen_children(arg0 : * mut
                        u8,) -> * mut u8 { $($path_to_types)*::
                        _export_method_screen_children_cabi::<<$ty as
                        $($path_to_types)*:: Guest >::Screen > (arg0) } #[export_name =
                        "cabi_post_unavi:vscreen/screen#[method]screen.children"] unsafe
                        extern "C" fn _post_return_method_screen_children(arg0 : * mut
                        u8,) { $($path_to_types)*::
                        __post_return_method_screen_children::<<$ty as
                        $($path_to_types)*:: Guest >::Screen > (arg0) } #[export_name =
                        "unavi:vscreen/screen#[method]screen.add-child"] unsafe extern
                        "C" fn export_method_screen_add_child(arg0 : * mut u8, arg1 :
                        i32,) { $($path_to_types)*::
                        _export_method_screen_add_child_cabi::<<$ty as
                        $($path_to_types)*:: Guest >::Screen > (arg0, arg1) }
                        #[export_name =
                        "unavi:vscreen/screen#[method]screen.remove-child"] unsafe extern
                        "C" fn export_method_screen_remove_child(arg0 : * mut u8, arg1 :
                        i32,) { $($path_to_types)*::
                        _export_method_screen_remove_child_cabi::<<$ty as
                        $($path_to_types)*:: Guest >::Screen > (arg0, arg1) }
                        #[export_name = "unavi:vscreen/screen#[method]screen.update"]
                        unsafe extern "C" fn export_method_screen_update(arg0 : * mut u8,
                        arg1 : f32,) { $($path_to_types)*::
                        _export_method_screen_update_cabi::<<$ty as $($path_to_types)*::
                        Guest >::Screen > (arg0, arg1) } const _ : () = { #[doc(hidden)]
                        #[export_name = "unavi:vscreen/screen#[dtor]screen"]
                        #[allow(non_snake_case)] unsafe extern "C" fn dtor(rep : * mut
                        u8) { $($path_to_types)*:: Screen::dtor::< <$ty as
                        $($path_to_types)*:: Guest >::Screen > (rep) } }; };
                    };
                }
                #[doc(hidden)]
...
macro_rules! __export_guest_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::unavi::vscreen::screen::__export_unavi_vscreen_screen_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::unavi::vscreen::screen);
    };
}
#[doc(inline)]
pub(crate) use __export_guest_impl as export;
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.35.0:unavi:vscreen:guest:encoded world"]
#[doc(hidden)]
...
lign-z\x01\x13\x03\0\x16unavi:layout/container\x05\x14\x02\x03\0\x09\x09containe\
r\x01B&\x02\x03\x02\x01\x15\x04\0\x09container\x03\0\0\x02\x03\x02\x01\x0c\x04\0\
\x09transform\x03\0\x02\x02\x03\x02\x01\x10\x04\0\x04vec2\x03\0\x04\x02\x03\x02\x01\
\x04\x04\0\x04vec3\x03\0\x06\x02\x03\x02\x01\x11\x04\0\x04node\x03\0\x08\x01q\x02\
\x06circle\x01v\0\x09rectangle\x01\x05\0\x04\0\x0cscreen-shape\x03\0\x0a\x04\0\x06\
screen\x03\x01\x01i\x0c\x01@\x01\x05shape\x0b\0\x0d\x04\0\x13[constructor]screen\
\x01\x0e\x01h\x0c\x01i\x01\x01@\x01\x04self\x0f\0\x10\x04\0\x13[method]screen.ro\
ot\x01\x11\x01@\x01\x04self\x0f\0\x7f\x04\0\x13[method]screen.open\x01\x12\x01@\x02\
\x04self\x0f\x05value\x7f\x01\0\x04\0\x17[method]screen.set-open\x01\x13\x04\0\x16\
[method]screen.visible\x01\x12\x04\0\x1a[method]screen.set-visible\x01\x13\x01@\x01\
\x04self\x0f\0v\x04\0![method]screen.animation-duration\x01\x14\x01@\x02\x04self\
\x0f\x05valuev\x01\0\x04\0%[method]screen.set-animation-duration\x01\x15\x01p\x0d\
...
[method]screen.update\x01\x19\x04\0\x14unavi:vscreen/screen\x05\x16\x04\0\x13una\
vi:vscreen/guest\x04\0\x0b\x0b\x01\0\x05guest\x03\0\0\0G\x09producers\x01\x0cpro\
