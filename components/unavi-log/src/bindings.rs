    ...
    pub mod unavi {
        ...
        pub mod log {
            ...
            pub mod api {
                ...
                macro_rules! __export_unavi_log_api_cabi{
        ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

          #[export_name = "unavi:log/api#log"]
          unsafe extern "C" fn export_log(arg0: i32,arg1: *mut u8,arg2: usize,) {
            $($path_to_types)*::_export_log_cabi::<$ty>(arg0, arg1, arg2)
                ...
                #[doc(hidden)]
                pub(crate) use __export_unavi_log_api_cabi;
            }
        }
    }
}
...
macro_rules! __export_lib_impl {
  ...
  $($path_to_types_root)*::exports::unavi::log::api::__export_unavi_log_api_cabi!($ty with_types_in $($path_to_types_root)*::exports::unavi::log::api);
  )
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.24.0:lib:encoded world"]
#[doc(hidden)]
...
\x02\x05level\x01\x03msgs\x01\0\x04\0\x03log\x01\x02\x04\x01\x0dunavi:log/api\x05\
\0\x04\x01\x0dunavi:log/lib\x04\0\x0b\x09\x01\0\x03lib\x03\0\0\0G\x09producers\x01\
