...
export class ThreeOutlinePass extends Pass {
  ...
  render(renderer, writeBuffer, readBuffer, deltaTime, maskActive) {
    if (this.selectedObjects.length > 0) {
      ...
      this.separableBlurMaterial1.uniforms["direction"].value = ThreeOutlinePass.BlurDirectionX;
      ...
      this.separableBlurMaterial1.uniforms["direction"].value = ThreeOutlinePass.BlurDirectionY;
      renderer.setRenderTarget(this.renderTargetEdgeBuffer1);
      renderer.clear();
      this.fsQuad.render(renderer);
      ...
      this.separableBlurMaterial2.uniforms["colorTexture"].value =
        this.renderTargetEdgeBuffer1.texture;
      this.separableBlurMaterial2.uniforms["direction"].value = ThreeOutlinePass.BlurDirectionX;
      renderer.setRenderTarget(this.renderTargetBlurBuffer2);
      renderer.clear();
      this.fsQuad.render(renderer);
      this.separableBlurMaterial2.uniforms["colorTexture"].value =
        this.renderTargetBlurBuffer2.texture;
      this.separableBlurMaterial2.uniforms["direction"].value = ThreeOutlinePass.BlurDirectionY;
...
ThreeOutlinePass.BlurDirectionX = new Vector2(1.0, 0.0);
ThreeOutlinePass.BlurDirectionY = new Vector2(0.0, 1.0);
