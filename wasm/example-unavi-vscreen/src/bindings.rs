...
\x01\x04self\x0f\0v\x04\0![method]screen.animation-duration\x01\x14\x01@\x02\x04\
self\x0f\x05valuev\x01\0\x04\0%[method]screen.set-animation-duration\x01\x15\x01\
