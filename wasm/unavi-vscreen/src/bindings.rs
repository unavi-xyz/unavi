            ...
            pub mod screen {
                ...
                impl Screen {
                    ...
                    pub fn new<T: GuestScreen>(val: T) -> Self {
                        ...
                        let ptr: *mut _ScreenRep<T> = _rt::Box::into_raw(_rt::Box::new(val));
                ...
                pub unsafe fn _export_method_screen_root_cabi<T: GuestScreen>(
                    ...
                    #[cfg(target_arch = "wasm32")]
                    _rt::run_ctors_once();
                    let result0 = T::root(ScreenBorrow::lift(arg0 as u32 as usize).get());
                ...
                pub unsafe fn _export_method_screen_visible_cabi<T: GuestScreen>(
                    ...
                    #[cfg(target_arch = "wasm32")]
                    _rt::run_ctors_once();
                    let result0 = T::visible(ScreenBorrow::lift(arg0 as u32 as usize).get());
                    match result0 {
                        true => 1,
                        false => 0,
                    }
