...
use super::{
    state::{RuntimeData, StoreState},
    {LoadResult, LoadedScript, LoadingScript, bindings},
};
use crate::{
    EventRegistry, InputRegistry, ScriptEngine, WasmBinary,
    asset::Wasm,
    firewall::HsdFirewall,
    load::HsdScriptSource,
    native::{
        WasmEngine,
...
pub async fn instantiate_component(
    ...
    crate::native::api::wired::add_to_linker(&mut linker, &perms)?;
