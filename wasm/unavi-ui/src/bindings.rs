        ...
        pub mod types {
            ...
            unsafe impl _rt::WasmResource for Scene {
                ...
                unsafe fn drop(_handle: u32) {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    {
                        #[link(wasm_import_module = "unavi:scene/types")]
                        extern "C" {
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 5090] = *b"\
...
remove-scene\x01\x13\x03\x01\x11unavi:scene/types\x05\x11\x01B\x1c\x02\x03\x02\x01\
