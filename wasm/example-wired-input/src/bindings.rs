...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.35.0:example:wired-input:script:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 8482] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xa5A\x01A\x02\x01A,\x01\
...
wired:script/types\x05\x1c\x04\0\x1aexample:wired-input/script\x04\0\x0b\x0c\x01\
