    ...
    pub mod unavi {
        ...
        pub mod scene {
            ...
            pub mod api {
                ...
                type _SceneRep<T> = Option<T>;
                impl Scene {
                    /// Creates a new resource from the specified representation.
                    ///
                    /// This function will create a new resource handle by moving `val` onto
                    /// the heap and then passing that heap pointer to the component model to
                    /// create a handle. The owned handle is then returned as `Scene`.
                    pub fn new<T: GuestScene>(val: T) -> Self {
                        Self::type_guard::<T>();
                        let val: _SceneRep<T> = Some(val);
                        let ptr: *mut _SceneRep<T> = _rt::Box::into_raw(_rt::Box::new(val));
                        unsafe { Self::from_handle(T::_resource_new(ptr.cast())) }
                    }
                    /// Gets access to the underlying `T` which represents this resource.
                    pub fn get<T: GuestScene>(&self) -> &T {
                        let ptr = unsafe { &*self.as_ptr::<T>() };
                        ptr.as_ref().unwrap()
                    }
                    /// Gets mutable access to the underlying `T` which represents this
                    /// resource.
                    pub fn get_mut<T: GuestScene>(&mut self) -> &mut T {
                        let ptr = unsafe { &mut *self.as_ptr::<T>() };
                        ptr.as_mut().unwrap()
                    }
                    /// Consumes this resource and returns the underlying `T`.
                    pub fn into_inner<T: GuestScene>(self) -> T {
                        let ptr = unsafe { &mut *self.as_ptr::<T>() };
                        ptr.take().unwrap()
                    }
                    #[doc(hidden)]
                    ...
                    pub unsafe fn dtor<T: 'static>(handle: *mut u8) {
                        Self::type_guard::<T>();
                        let _ = _rt::Box::from_raw(handle as *mut _SceneRep<T>);
                    }
                    fn as_ptr<T: GuestScene>(&self) -> *mut _SceneRep<T> {
                        Scene::type_guard::<T>();
                        T::_resource_rep(self.handle()).cast()
                    }
                }
                /// A borrowed version of [`Scene`] which represents a borrowed value
                /// with the lifetime `'a`.
                #[derive(Debug)]
                #[repr(transparent)]
                pub struct SceneBorrow<'a> {
                    rep: *mut u8,
                    _marker: core::marker::PhantomData<&'a Scene>,
                }
                impl<'a> SceneBorrow<'a> {
                    #[doc(hidden)]
                    pub unsafe fn lift(rep: usize) -> Self {
                        Self {
                            rep: rep as *mut u8,
                    ...
                    fn as_ptr<T: 'static>(&self) -> *mut _SceneRep<T> {
                        Scene::type_guard::<T>();
                        self.rep.cast()
                    }
                }
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_constructor_scene_cabi<T: GuestScene>() -> i32 {
                    #[cfg(target_arch = "wasm32")]
                    _rt::run_ctors_once();
                    let result0 = Scene::new(T::new());
                    (result0).take_handle() as i32
                }
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_scene_list_nodes_cabi<T: GuestScene>(
                    arg0: *mut u8,
                ) -> *mut u8 {
                    #[cfg(target_arch = "wasm32")]
                    _rt::run_ctors_once();
                    let result0 = T::list_nodes(SceneBorrow::lift(arg0 as u32 as usize).get());
                    let ptr1 = _RET_AREA.0.as_mut_ptr().cast::<u8>();
                    let vec2 = result0;
                    let len2 = vec2.len();
                    let layout2 = _rt::alloc::Layout::from_size_align_unchecked(vec2.len() * 4, 4);
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_method_scene_list_nodes<T: GuestScene>(arg0: *mut u8) {
                    let l0 = *arg0.add(0).cast::<*mut u8>();
                    let l1 = *arg0.add(4).cast::<usize>();
                    let base2 = l0;
                    let len2 = l1;
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_scene_add_node_cabi<T: GuestScene>(
                    arg0: *mut u8,
                    arg1: i32,
                ) {
                    #[cfg(target_arch = "wasm32")]
                    _rt::run_ctors_once();
                    let handle0;
                    T::add_node(SceneBorrow::lift(arg0 as u32 as usize).get(), {
                        handle0 = super::super::super::super::wired::scene::node::Node::from_handle(
                            arg1 as u32,
                        );
                        &handle0
                    });
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_scene_remove_node_cabi<T: GuestScene>(
                    arg0: *mut u8,
                    arg1: i32,
                ) {
                    #[cfg(target_arch = "wasm32")]
                    _rt::run_ctors_once();
                    let handle0;
                    T::remove_node(SceneBorrow::lift(arg0 as u32 as usize).get(), {
                        handle0 = super::super::super::super::wired::scene::node::Node::from_handle(
                            arg1 as u32,
                        );
                        &handle0
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_scene_transform_cabi<T: GuestScene>(
                    arg0: *mut u8,
                ) -> *mut u8 {
                    #[cfg(target_arch = "wasm32")]
                    _rt::run_ctors_once();
                    let result0 = T::transform(SceneBorrow::lift(arg0 as u32 as usize).get());
                    let ptr1 = _RET_AREA.0.as_mut_ptr().cast::<u8>();
                    ...
                    *ptr1.add(12).cast::<f32>() = _rt::as_f32(w3);
                    let super::super::super::super::wired::math::types::Vec3 {
                        x: x4,
                        y: y4,
                        z: z4,
                    } = scale2;
                    *ptr1.add(16).cast::<f32>() = _rt::as_f32(x4);
                    *ptr1.add(20).cast::<f32>() = _rt::as_f32(y4);
                    *ptr1.add(24).cast::<f32>() = _rt::as_f32(z4);
                    let super::super::super::super::wired::math::types::Vec3 {
                        x: x5,
                        y: y5,
                        z: z5,
                    } = translation2;
                    *ptr1.add(28).cast::<f32>() = _rt::as_f32(x5);
                    *ptr1.add(32).cast::<f32>() = _rt::as_f32(y5);
                    *ptr1.add(36).cast::<f32>() = _rt::as_f32(z5);
                    ptr1
                }
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_scene_set_transform_cabi<T: GuestScene>(
                    arg0: *mut u8,
                    arg1: f32,
                    arg2: f32,
                    arg3: f32,
                    ...
                    _rt::run_ctors_once();
                    T::set_transform(
                        SceneBorrow::lift(arg0 as u32 as usize).get(),
                        super::super::super::super::wired::math::types::Transform {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_scene_active_cabi<T: GuestScene>(
                    arg0: *mut u8,
                ) -> i32 {
                    #[cfg(target_arch = "wasm32")]
                    _rt::run_ctors_once();
                    let result0 = T::active(SceneBorrow::lift(arg0 as u32 as usize).get());
                    match result0 {
                        true => 1,
                        false => 0,
                    }
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_scene_set_active_cabi<T: GuestScene>(
                    arg0: *mut u8,
                    arg1: i32,
                ) {
                    #[cfg(target_arch = "wasm32")]
                ...
                macro_rules! __export_unavi_scene_api_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "unavi:scene/api#[static]root.list-scenes"] unsafe extern "C" fn
                        export_static_root_list_scenes() -> * mut u8 {
                        $($path_to_types)*:: _export_static_root_list_scenes_cabi::<<$ty
                        as $($path_to_types)*:: Guest >::Root > () } #[export_name =
                        "cabi_post_unavi:scene/api#[static]root.list-scenes"] unsafe
                        extern "C" fn _post_return_static_root_list_scenes(arg0 : * mut
                        u8,) { $($path_to_types)*::
                        __post_return_static_root_list_scenes::<<$ty as
                        $($path_to_types)*:: Guest >::Root > (arg0) } #[export_name =
                        "unavi:scene/api#[static]root.add-scene"] unsafe extern "C" fn
                        export_static_root_add_scene(arg0 : i32,) { $($path_to_types)*::
                        _export_static_root_add_scene_cabi::<<$ty as $($path_to_types)*::
                        Guest >::Root > (arg0) } #[export_name =
                        "unavi:scene/api#[static]root.remove-scene"] unsafe extern "C" fn
                        export_static_root_remove_scene(arg0 : i32,) {
                        $($path_to_types)*:: _export_static_root_remove_scene_cabi::<<$ty
                        as $($path_to_types)*:: Guest >::Root > (arg0) } #[export_name =
                        "unavi:scene/api#[constructor]scene"] unsafe extern "C" fn
                        export_constructor_scene() -> i32 { $($path_to_types)*::
                        _export_constructor_scene_cabi::<<$ty as $($path_to_types)*::
                        Guest >::Scene > () } #[export_name =
                        "unavi:scene/api#[method]scene.list-nodes"] unsafe extern "C" fn
                        export_method_scene_list_nodes(arg0 : * mut u8,) -> * mut u8 {
                        $($path_to_types)*:: _export_method_scene_list_nodes_cabi::<<$ty
                        as $($path_to_types)*:: Guest >::Scene > (arg0) } #[export_name =
                        "cabi_post_unavi:scene/api#[method]scene.list-nodes"] unsafe
                        extern "C" fn _post_return_method_scene_list_nodes(arg0 : * mut
                        u8,) { $($path_to_types)*::
                        __post_return_method_scene_list_nodes::<<$ty as
                        $($path_to_types)*:: Guest >::Scene > (arg0) } #[export_name =
                        "unavi:scene/api#[method]scene.create-node"] unsafe extern "C" fn
                        export_method_scene_create_node(arg0 : * mut u8,) -> i32 {
                        $($path_to_types)*:: _export_method_scene_create_node_cabi::<<$ty
                        as $($path_to_types)*:: Guest >::Scene > (arg0) } #[export_name =
                        "unavi:scene/api#[method]scene.add-node"] unsafe extern "C" fn
                        export_method_scene_add_node(arg0 : * mut u8, arg1 : i32,) {
                        $($path_to_types)*:: _export_method_scene_add_node_cabi::<<$ty as
                        $($path_to_types)*:: Guest >::Scene > (arg0, arg1) }
                        #[export_name = "unavi:scene/api#[method]scene.remove-node"]
                        unsafe extern "C" fn export_method_scene_remove_node(arg0 : * mut
                        u8, arg1 : i32,) { $($path_to_types)*::
                        _export_method_scene_remove_node_cabi::<<$ty as
                        $($path_to_types)*:: Guest >::Scene > (arg0, arg1) }
                        #[export_name = "unavi:scene/api#[method]scene.transform"] unsafe
                        extern "C" fn export_method_scene_transform(arg0 : * mut u8,) ->
                        * mut u8 { $($path_to_types)*::
                        _export_method_scene_transform_cabi::<<$ty as
                        $($path_to_types)*:: Guest >::Scene > (arg0) } #[export_name =
                        "unavi:scene/api#[method]scene.set-transform"] unsafe extern "C"
                        fn export_method_scene_set_transform(arg0 : * mut u8, arg1 : f32,
                        arg2 : f32, arg3 : f32, arg4 : f32, arg5 : f32, arg6 : f32, arg7
                        : f32, arg8 : f32, arg9 : f32, arg10 : f32,) {
                        $($path_to_types)*::
                        _export_method_scene_set_transform_cabi::<<$ty as
                        $($path_to_types)*:: Guest >::Scene > (arg0, arg1, arg2, arg3,
                        arg4, arg5, arg6, arg7, arg8, arg9, arg10) } #[export_name =
                        "unavi:scene/api#[method]scene.active"] unsafe extern "C" fn
                        export_method_scene_active(arg0 : * mut u8,) -> i32 {
                        $($path_to_types)*:: _export_method_scene_active_cabi::<<$ty as
                        $($path_to_types)*:: Guest >::Scene > (arg0) } #[export_name =
                        "unavi:scene/api#[method]scene.set-active"] unsafe extern "C" fn
                        export_method_scene_set_active(arg0 : * mut u8, arg1 : i32,) {
                        $($path_to_types)*:: _export_method_scene_set_active_cabi::<<$ty
                        as $($path_to_types)*:: Guest >::Scene > (arg0, arg1) } const _ :
                        () = { #[doc(hidden)] #[export_name =
                        "unavi:scene/api#[dtor]root"] #[allow(non_snake_case)] unsafe
                        extern "C" fn dtor(rep : * mut u8) { $($path_to_types)*::
                        Root::dtor::< <$ty as $($path_to_types)*:: Guest >::Root > (rep)
                        } }; const _ : () = { #[doc(hidden)] #[export_name =
                        "unavi:scene/api#[dtor]scene"] #[allow(non_snake_case)] unsafe
                        extern "C" fn dtor(rep : * mut u8) { $($path_to_types)*::
                        Scene::dtor::< <$ty as $($path_to_types)*:: Guest >::Scene >
                        (rep) } }; };
                    };
                }
                #[doc(hidden)]
...
macro_rules! __export_guest_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::unavi::scene::api::__export_unavi_scene_api_cabi!($ty with_types_in
        $($path_to_types_root)*:: exports::unavi::scene::api);
    };
}
#[doc(inline)]
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 7313] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x958\x01A\x02\x01A\"\
...
\x06\x04node\x01B\x15\x02\x03\x02\x01\x10\x04\0\x04node\x03\0\0\x04\0\x05scene\x03\
...
\x01\x11wired:scene/scene\x05\x11\x02\x03\0\x07\x05scene\x01B5\x02\x03\x02\x01\x02\
\x04\0\x08material\x03\0\0\x02\x03\x02\x01\x0a\x04\0\x04mesh\x03\0\x02\x02\x03\x02\
\x01\x10\x04\0\x04node\x03\0\x04\x02\x03\x02\x01\x12\x04\0\x05scene\x03\0\x06\x04\
...
ne\x01\x1f\x03\x01\x10wired:scene/gltf\x05\x13\x02\x03\0\x08\x04gltf\x01Bt\x02\x03\
\x02\x01\x14\x04\0\x04gltf\x03\0\0\x02\x03\x02\x01\x10\x04\0\x04node\x03\0\x02\x02\
...
ot\x01\x1c\x03\x01\x10wired:scene/glxf\x05\x15\x01B\"\x02\x03\x02\x01\x0c\x04\0\x09\
...
\x01\0\x04\0\x18[method]scene.set-active\x01\x15\x04\x01\x0funavi:scene/api\x05\x16\
\x04\x01\x11unavi:scene/guest\x04\0\x0b\x0b\x01\0\x05guest\x03\0\0\0G\x09produce\
