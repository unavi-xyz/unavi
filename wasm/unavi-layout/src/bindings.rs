...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.35.0:unavi:layout:guest:encoded world"]
#[doc(hidden)]
...
method]container.set-align-z\x01\x13\x04\0\x16unavi:layout/container\x05\x11\x02\
...
\0\x04\0\x15[method]grid.set-rows\x01\x0f\x04\0\x11unavi:layout/grid\x05\x13\x04\
\0\x12unavi:layout/guest\x04\0\x0b\x0b\x01\0\x05guest\x03\0\0\0G\x09producers\x01\
