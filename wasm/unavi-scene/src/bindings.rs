        ...
        pub mod scene {
            ...
            pub mod api {
                ...
                impl Scene {
                    ...
                    // It's theoretically possible to implement the `GuestScene` trait twice
                    // so guard against using it with two different types here.
                    #[doc(hidden)]
                    fn type_guard<T: 'static>() {
                        use core::any::TypeId;
  ...
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
    ...
    const _: () = {
      ...
      unsafe extern "C" fn dtor(rep: *mut u8) {
        ...
        <$ty as $($path_to_types)*::Guest>::Scene
        >(rep)
      }
    };
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 7058] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x966\x01A\x02\x01A\"\
...
B\x15\x02\x03\x02\x01\x10\x04\0\x04node\x03\0\0\x04\0\x05scene\x03\x01\x01i\x02\x01\
...
scene\x05\x11\x02\x03\0\x07\x05scene\x01B5\x02\x03\x02\x01\x02\x04\0\x08material\
\x03\0\0\x02\x03\x02\x01\x0a\x04\0\x04mesh\x03\0\x02\x02\x03\x02\x01\x10\x04\0\x04\
node\x03\0\x04\x02\x03\x02\x01\x12\x04\0\x05scene\x03\0\x06\x04\0\x04gltf\x03\x01\
...
wired:scene/gltf\x05\x13\x02\x03\0\x08\x04gltf\x01Bt\x02\x03\x02\x01\x14\x04\0\x04\
gltf\x03\0\0\x02\x03\x02\x01\x10\x04\0\x04node\x03\0\x02\x02\x03\x02\x01\x0c\x04\
