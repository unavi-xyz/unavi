...
pub mod exports {
        ...
        pub mod shapes {
            ...
            pub mod api {
                ...
                impl Cylinder {
                    ...
                    // It's theoretically possible to implement the `GuestCylinder` trait twice
                    // so guard against using it with two different types here.
                    #[doc(hidden)]
                    fn type_guard<T: 'static>() {
                        use core::any::TypeId;
                ...
                impl Cuboid {
                    ...
                    // It's theoretically possible to implement the `GuestCuboid` trait twice
                    // so guard against using it with two different types here.
                    #[doc(hidden)]
                    fn type_guard<T: 'static>() {
                        use core::any::TypeId;
                ...
                impl Sphere {
                    ...
                    // It's theoretically possible to implement the `GuestSphere` trait twice
                    // so guard against using it with two different types here.
                    #[doc(hidden)]
                    fn type_guard<T: 'static>() {
                        use core::any::TypeId;
  ...
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
    ...
    unsafe extern "C" fn export_method_cylinder_height(arg0: *mut u8,) -> f32 {
      $($path_to_types)*::_export_method_cylinder_height_cabi::<<$ty as $($path_to_types)*::Guest>::Cylinder>(arg0)
    }
    ...
    unsafe extern "C" fn export_method_cylinder_to_mesh(arg0: *mut u8,) -> i32 {
      $($path_to_types)*::_export_method_cylinder_to_mesh_cabi::<<$ty as $($path_to_types)*::Guest>::Cylinder>(arg0)
    }
    #[export_name = "unavi:shapes/api#[method]cylinder.to-node"]
    unsafe extern "C" fn export_method_cylinder_to_node(arg0: *mut u8,) -> i32 {
      $($path_to_types)*::_export_method_cylinder_to_node_cabi::<<$ty as $($path_to_types)*::Guest>::Cylinder>(arg0)
    }
    #[export_name = "unavi:shapes/api#[method]cylinder.to-physics-node"]
    unsafe extern "C" fn export_method_cylinder_to_physics_node(arg0: *mut u8,) -> i32 {
      $($path_to_types)*::_export_method_cylinder_to_physics_node_cabi::<<$ty as $($path_to_types)*::Guest>::Cylinder>(arg0)
    }
    #[export_name = "unavi:shapes/api#[constructor]cuboid"]
    unsafe extern "C" fn export_constructor_cuboid(arg0: f32,arg1: f32,arg2: f32,) -> i32 {
      $($path_to_types)*::_export_constructor_cuboid_cabi::<<$ty as $($path_to_types)*::Guest>::Cuboid>(arg0, arg1, arg2)
    }
    #[export_name = "unavi:shapes/api#[method]cuboid.size"]
    unsafe extern "C" fn export_method_cuboid_size(arg0: *mut u8,) -> *mut u8 {
      $($path_to_types)*::_export_method_cuboid_size_cabi::<<$ty as $($path_to_types)*::Guest>::Cuboid>(arg0)
    }
    #[export_name = "unavi:shapes/api#[method]cuboid.set-size"]
    unsafe extern "C" fn export_method_cuboid_set_size(arg0: *mut u8,arg1: f32,arg2: f32,arg3: f32,) {
      $($path_to_types)*::_export_method_cuboid_set_size_cabi::<<$ty as $($path_to_types)*::Guest>::Cuboid>(arg0, arg1, arg2, arg3)
    }
    #[export_name = "unavi:shapes/api#[method]cuboid.to-mesh"]
    unsafe extern "C" fn export_method_cuboid_to_mesh(arg0: *mut u8,) -> i32 {
      $($path_to_types)*::_export_method_cuboid_to_mesh_cabi::<<$ty as $($path_to_types)*::Guest>::Cuboid>(arg0)
    }
    #[export_name = "unavi:shapes/api#[method]cuboid.to-node"]
    unsafe extern "C" fn export_method_cuboid_to_node(arg0: *mut u8,) -> i32 {
      $($path_to_types)*::_export_method_cuboid_to_node_cabi::<<$ty as $($path_to_types)*::Guest>::Cuboid>(arg0)
    }
    #[export_name = "unavi:shapes/api#[method]cuboid.to-physics-node"]
    unsafe extern "C" fn export_method_cuboid_to_physics_node(arg0: *mut u8,) -> i32 {
      $($path_to_types)*::_export_method_cuboid_to_physics_node_cabi::<<$ty as $($path_to_types)*::Guest>::Cuboid>(arg0)
    }
    #[export_name = "unavi:shapes/api#[static]sphere.new-ico"]
    unsafe extern "C" fn export_static_sphere_new_ico(arg0: f32,) -> i32 {
      $($path_to_types)*::_export_static_sphere_new_ico_cabi::<<$ty as $($path_to_types)*::Guest>::Sphere>(arg0)
    }
    #[export_name = "unavi:shapes/api#[static]sphere.new-uv"]
    unsafe extern "C" fn export_static_sphere_new_uv(arg0: f32,) -> i32 {
      $($path_to_types)*::_export_static_sphere_new_uv_cabi::<<$ty as $($path_to_types)*::Guest>::Sphere>(arg0)
    }
    #[export_name = "unavi:shapes/api#[method]sphere.radius"]
    unsafe extern "C" fn export_method_sphere_radius(arg0: *mut u8,) -> f32 {
      $($path_to_types)*::_export_method_sphere_radius_cabi::<<$ty as $($path_to_types)*::Guest>::Sphere>(arg0)
    }
    #[export_name = "unavi:shapes/api#[method]sphere.set-radius"]
    unsafe extern "C" fn export_method_sphere_set_radius(arg0: *mut u8,arg1: f32,) {
      $($path_to_types)*::_export_method_sphere_set_radius_cabi::<<$ty as $($path_to_types)*::Guest>::Sphere>(arg0, arg1)
    }
    #[export_name = "unavi:shapes/api#[method]sphere.kind"]
    unsafe extern "C" fn export_method_sphere_kind(arg0: *mut u8,) -> *mut u8 {
      $($path_to_types)*::_export_method_sphere_kind_cabi::<<$ty as $($path_to_types)*::Guest>::Sphere>(arg0)
    }
    #[export_name = "unavi:shapes/api#[method]sphere.set-kind"]
    unsafe extern "C" fn export_method_sphere_set_kind(arg0: *mut u8,arg1: i32,arg2: i32,arg3: i32,) {
      $($path_to_types)*::_export_method_sphere_set_kind_cabi::<<$ty as $($path_to_types)*::Guest>::Sphere>(arg0, arg1, arg2, arg3)
    }
    #[export_name = "unavi:shapes/api#[method]sphere.to-mesh"]
    unsafe extern "C" fn export_method_sphere_to_mesh(arg0: *mut u8,) -> i32 {
      $($path_to_types)*::_export_method_sphere_to_mesh_cabi::<<$ty as $($path_to_types)*::Guest>::Sphere>(arg0)
    }
    #[export_name = "unavi:shapes/api#[method]sphere.to-node"]
    unsafe extern "C" fn export_method_sphere_to_node(arg0: *mut u8,) -> i32 {
      $($path_to_types)*::_export_method_sphere_to_node_cabi::<<$ty as $($path_to_types)*::Guest>::Sphere>(arg0)
    }
    #[export_name = "unavi:shapes/api#[method]sphere.to-physics-node"]
    ...
    const _: () = {
      #[doc(hidden)]
      #[export_name = "unavi:shapes/api#[dtor]cylinder"]
      #[allow(non_snake_case)]
      unsafe extern "C" fn dtor(rep: *mut u8) {
        $($path_to_types)*::Cylinder::dtor::<
    ...
    const _: () = {
      #[doc(hidden)]
      #[export_name = "unavi:shapes/api#[dtor]cuboid"]
      #[allow(non_snake_case)]
      unsafe extern "C" fn dtor(rep: *mut u8) {
        $($path_to_types)*::Cuboid::dtor::<
        <$ty as $($path_to_types)*::Guest>::Cuboid
        >(rep)
      }
    };
    ...
    const _: () = {
      #[doc(hidden)]
      #[export_name = "unavi:shapes/api#[dtor]sphere"]
      #[allow(non_snake_case)]
      unsafe extern "C" fn dtor(rep: *mut u8) {
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 5212] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xdf'\x01A\x02\x01A\x1d\
...
\0\x1a[method]material.set-color\x01\x0a\x03\x01\x14wired:scene/material\x05\x01\
\x02\x03\0\x01\x08material\x01B)\x02\x03\x02\x01\x02\x04\0\x08material\x03\0\0\x04\
\0\x09primitive\x03\x01\x04\0\x04mesh\x03\x01\x01h\x02\x01@\x01\x04self\x04\0y\x04\
\0\x14[method]primitive.id\x01\x05\x01i\x01\x01k\x06\x01@\x01\x04self\x04\0\x07\x04\
\0\x1a[method]primitive.material\x01\x08\x01h\x01\x01k\x09\x01@\x02\x04self\x04\x05\
value\x0a\x01\0\x04\0\x1e[method]primitive.set-material\x01\x0b\x01py\x01@\x02\x04\
self\x04\x05value\x0c\x01\0\x04\0\x1d[method]primitive.set-indices\x01\x0d\x01pv\
\x01@\x02\x04self\x04\x05value\x0e\x01\0\x04\0\x1d[method]primitive.set-normals\x01\
\x0f\x04\0\x1f[method]primitive.set-positions\x01\x0f\x04\0\x19[method]primitive\
.set-uvs\x01\x0f\x01i\x03\x01@\0\0\x10\x04\0\x11[constructor]mesh\x01\x11\x01h\x03\
\x01@\x01\x04self\x12\0y\x04\0\x0f[method]mesh.id\x01\x13\x01@\x01\x04self\x12\0\
s\x04\0\x11[method]mesh.name\x01\x14\x01@\x02\x04self\x12\x05values\x01\0\x04\0\x15\
[method]mesh.set-name\x01\x15\x01i\x02\x01p\x16\x01@\x01\x04self\x12\0\x17\x04\0\
...
form\x02\x03\0\x06\x08collider\x02\x03\0\x06\x0arigid-body\x01BD\x02\x03\x02\x01\
...
method]node.parent\x01\x16\x01@\x01\x04self\x0d\0\x05\x04\0\x16[method]node.tran\
sform\x01\x17\x01@\x02\x04self\x0d\x05value\x05\x01\0\x04\0\x1a[method]node.set-\
transform\x01\x18\x01i\x01\x01k\x19\x01@\x01\x04self\x0d\0\x1a\x04\0\x11[method]\
node.mesh\x01\x1b\x01h\x01\x01k\x1c\x01@\x02\x04self\x0d\x05value\x1d\x01\0\x04\0\
\x15[method]node.set-mesh\x01\x1e\x01i\x07\x01k\x1f\x01@\x01\x04self\x0d\0\x20\x04\
\0\x15[method]node.collider\x01!\x01h\x07\x01k\"\x01@\x02\x04self\x0d\x05value#\x01\
...
wired:scene/node\x05\x10\x02\x03\0\x03\x04vec2\x02\x03\0\x07\x04node\x01BY\x02\x03\
\x02\x01\x11\x04\0\x04vec2\x03\0\0\x02\x03\x02\x01\x05\x04\0\x04vec3\x03\0\x02\x02\
\x03\x02\x01\x0b\x04\0\x04mesh\x03\0\x04\x02\x03\x02\x01\x12\x04\0\x04node\x03\0\
\x06\x04\0\x09rectangle\x03\x01\x04\0\x08cylinder\x03\x01\x04\0\x06cuboid\x03\x01\
\x01r\x01\x0csubdivisions}\x04\0\x0asphere-ico\x03\0\x0b\x01r\x02\x07sectors}\x06\
stacks}\x04\0\x09sphere-uv\x03\0\x0d\x01q\x02\x03ico\x01\x0c\0\x02uv\x01\x0e\0\x04\
\0\x0bsphere-kind\x03\0\x0f\x04\0\x06sphere\x03\x01\x01i\x08\x01@\x01\x04size\x01\
\0\x12\x04\0\x16[constructor]rectangle\x01\x13\x01h\x08\x01@\x01\x04self\x14\0\x01\
\x04\0\x16[method]rectangle.size\x01\x15\x01@\x02\x04self\x14\x05value\x01\x01\0\
\x04\0\x1a[method]rectangle.set-size\x01\x16\x01i\x05\x01@\x01\x04self\x14\0\x17\
\x04\0\x19[method]rectangle.to-mesh\x01\x18\x01i\x07\x01@\x01\x04self\x14\0\x19\x04\
\0\x19[method]rectangle.to-node\x01\x1a\x04\0![method]rectangle.to-physics-node\x01\
\x1a\x01i\x09\x01@\x02\x06radiusv\x06heightv\0\x1b\x04\0\x15[constructor]cylinde\
r\x01\x1c\x01h\x09\x01@\x01\x04self\x1d\0\x7f\x04\0\x14[method]cylinder.cap\x01\x1e\
\x01@\x02\x04self\x1d\x05value\x7f\x01\0\x04\0\x18[method]cylinder.set-cap\x01\x1f\
\x01@\x01\x04self\x1d\0v\x04\0\x17[method]cylinder.height\x01\x20\x01@\x02\x04se\
lf\x1d\x05valuev\x01\0\x04\0\x1b[method]cylinder.set-height\x01!\x04\0\x17[metho\
d]cylinder.radius\x01\x20\x04\0\x1b[method]cylinder.set-radius\x01!\x01@\x01\x04\
self\x1d\0}\x04\0\x1b[method]cylinder.resolution\x01\"\x01@\x02\x04self\x1d\x05v\
alue}\x01\0\x04\0\x1f[method]cylinder.set-resolution\x01#\x04\0\x19[method]cylin\
der.segments\x01\"\x04\0\x1d[method]cylinder.set-segments\x01#\x01@\x01\x04self\x1d\
\0\x17\x04\0\x18[method]cylinder.to-mesh\x01$\x01@\x01\x04self\x1d\0\x19\x04\0\x18\
[method]cylinder.to-node\x01%\x04\0\x20[method]cylinder.to-physics-node\x01%\x01\
i\x0a\x01@\x01\x04size\x03\0&\x04\0\x13[constructor]cuboid\x01'\x01h\x0a\x01@\x01\
\x04self(\0\x03\x04\0\x13[method]cuboid.size\x01)\x01@\x02\x04self(\x05value\x03\
\x01\0\x04\0\x17[method]cuboid.set-size\x01*\x01@\x01\x04self(\0\x17\x04\0\x16[m\
ethod]cuboid.to-mesh\x01+\x01@\x01\x04self(\0\x19\x04\0\x16[method]cuboid.to-nod\
e\x01,\x04\0\x1e[method]cuboid.to-physics-node\x01,\x01i\x11\x01@\x01\x06radiusv\
\0-\x04\0\x16[static]sphere.new-ico\x01.\x04\0\x15[static]sphere.new-uv\x01.\x01\
h\x11\x01@\x01\x04self/\0v\x04\0\x15[method]sphere.radius\x010\x01@\x02\x04self/\
\x05valuev\x01\0\x04\0\x19[method]sphere.set-radius\x011\x01@\x01\x04self/\0\x10\
...
[method]sphere.to-physics-node\x015\x04\x01\x10unavi:shapes/api\x05\x13\x04\x01\x13\
unavi:shapes/shapes\x04\0\x0b\x0c\x01\0\x06shapes\x03\0\0\0G\x09producers\x01\x0c\
