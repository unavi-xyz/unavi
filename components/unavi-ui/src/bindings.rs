    ...
    pub mod unavi {
        pub mod ui {
            ...
            pub mod types {
                ...
                macro_rules! __export_unavi_ui_types_cabi{
        ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {


          #[export_name = "unavi:ui/types#new-bubble"]
          unsafe extern "C" fn export_new_bubble() -> *mut u8 {
            $($path_to_types)*::_export_new_bubble_cabi::<$ty>()
          }

          #[export_name = "cabi_post_unavi:ui/types#new-bubble"]
          unsafe extern "C" fn _post_return_new_bubble(arg0: *mut u8,) {
            $($path_to_types)*::__post_return_new_bubble::<$ty>(arg0)
                ...
                #[doc(hidden)]
                pub(crate) use __export_unavi_ui_types_cabi;
...
macro_rules! __export_ui_impl {
  ...
  $($path_to_types_root)*::exports::unavi::ui::types::__export_unavi_ui_types_cabi!($ty with_types_in $($path_to_types_root)*::exports::unavi::ui::types);
  )
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.20.0:ui:encoded world"]
#[doc(hidden)]
...
B\x02\x01@\0\0s\x04\0\x0anew-bubble\x01\0\x04\x01\x0eunavi:ui/types\x05\0\x04\x01\
\x0bunavi:ui/ui\x04\0\x0b\x08\x01\0\x02ui\x03\0\0\0G\x09producers\x01\x0cprocess\
