...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.35.0:example:wired-scene:script:encoded world"]
#[doc(hidden)]
...
wired:script/types\x05\x1c\x04\0\x1aexample:wired-scene/script\x04\0\x0b\x0c\x01\
