...
pub mod exports {
    ...
    pub mod unavi {
        ...
        ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
          ...
          #[export_name = "unavi:ui/api#update-ui"]
          unsafe extern "C" fn export_update_ui(arg0: f32,) {
  ...
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
    ...
    #[export_name = "unavi:ui/button#[method]button.hovered"]
    unsafe extern "C" fn export_method_button_hovered(arg0: *mut u8,) -> i32 {
      $($path_to_types)*::_export_method_button_hovered_cabi::<<$ty as $($path_to_types)*::Guest>::Button>(arg0)
    }
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6845] = *b"\
...
\0\x04vec2\x02\x03\0\x06\x04node\x01BY\x02\x03\x02\x01\x10\x04\0\x04vec2\x03\0\0\
...
sphere-ico\x03\0\x0b\x01r\x02\x07sectors}\x06stacks}\x04\0\x09sphere-uv\x03\0\x0d\
\x01q\x02\x03ico\x01\x0c\0\x02uv\x01\x0e\0\x04\0\x0bsphere-kind\x03\0\x0f\x04\0\x06\
sphere\x03\x01\x01i\x08\x01@\x01\x04size\x01\0\x12\x04\0\x16[constructor]rectang\
le\x01\x13\x01h\x08\x01@\x01\x04self\x14\0\x01\x04\0\x16[method]rectangle.size\x01\
...
ainer\x05\x13\x01B\x02\x01@\x01\x05deltav\x01\0\x04\0\x09update-ui\x01\0\x04\x01\
\x0cunavi:ui/api\x05\x14\x02\x03\0\x08\x09container\x01B\x0f\x02\x03\x02\x01\x15\
...
button.root\x01\x09\x01@\x01\x04self\x08\0\x7f\x04\0\x16[method]button.hovered\x01\
\x0a\x04\0\x16[method]button.pressed\x01\x0a\x04\x01\x0funavi:ui/button\x05\x16\x01\
B(\x02\x03\x02\x01\x15\x04\0\x09container\x03\0\0\x02\x03\x02\x01\x0a\x04\0\x04m\
esh\x03\0\x02\x02\x03\x02\x01\x11\x04\0\x04node\x03\0\x04\x04\0\x04text\x03\x01\x04\
\0\x08text-box\x03\x01\x01i\x06\x01@\x01\x04texts\0\x08\x04\0\x11[constructor]te\
xt\x01\x09\x01h\x06\x01@\x01\x04self\x0a\0\x08\x04\0\x10[method]text.ref\x01\x0b\
\x01p}\x01k\x0c\x01@\x02\x04self\x0a\x05value\x0d\x01\0\x04\0\x15[method]text.se\
t-font\x01\x0e\x01@\x01\x04self\x0a\0s\x04\0\x11[method]text.text\x01\x0f\x01@\x02\
\x04self\x0a\x05values\x01\0\x04\0\x15[method]text.set-text\x01\x10\x01@\x01\x04\
self\x0a\0v\x04\0\x16[method]text.font-size\x01\x11\x01@\x02\x04self\x0a\x05valu\
ev\x01\0\x04\0\x1a[method]text.set-font-size\x01\x12\x04\0\x16[method]text.thick\
ness\x01\x11\x04\0\x1a[method]text.set-thickness\x01\x12\x01i\x03\x01@\x01\x04se\
lf\x0a\0\x13\x04\0\x11[method]text.mesh\x01\x14\x01i\x01\x01i\x07\x01@\x01\x04ro\
ot\x15\0\x16\x04\0\x15[constructor]text-box\x01\x17\x01h\x07\x01@\x01\x04self\x18\
\0\x15\x04\0\x15[method]text-box.root\x01\x19\x01@\x01\x04self\x18\0\x08\x04\0\x15\
[method]text-box.text\x01\x1a\x04\x01\x0dunavi:ui/text\x05\x17\x04\x01\x0eunavi:\
ui/guest\x04\0\x0b\x0b\x01\0\x05guest\x03\0\0\0G\x09producers\x01\x0cprocessed-b\
