...
#[doc(hidden)]
pub(crate) use __export_world_ui_cabi;
...
macro_rules! __export_ui_impl {
  ...
  $($path_to_types_root)*::__export_world_ui_cabi!($ty with_types_in $($path_to_types_root)*);
  )
}
#[doc(inline)]
...
@\0\0s\x04\0\x0anew-bubble\x01\0\x04\x01\x0bunavi:ui/ui\x04\0\x0b\x08\x01\0\x02u\
i\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.201.0\x10\
