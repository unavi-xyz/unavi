...
export type GetProfilesByAddressQuery = {
  __typename?: "Query";
  profiles: {
    __typename?: "PaginatedProfileResult";
    items: Array<{
...
export type GetDefaultProfileQuery = {
  __typename?: "Query";
  defaultProfile?: {
    __typename?: "Profile";
    id: any;
...
export type RefreshAuthenticationMutationVariables = Exact<{
  refreshToken: Scalars["Jwt"];
}>;

export type RefreshAuthenticationMutation = {
  __typename?: "Mutation";
  refresh: {
    __typename?: "AuthenticationResult";
    accessToken: any;
...
`;
export const GetProfilesByAddressDocument = gql`
...
/**
 * __useGetProfilesByAddressQuery__
 *
 * To run a query within a React component, call `useGetProfilesByAddressQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetProfilesByAddressQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetProfilesByAddressQuery({
 *   variables: {
 *      address: // value for 'address'
 *   },
 * });
 */
export function useGetProfilesByAddressQuery(
  ...
  return Apollo.useQuery<
    GetProfilesByAddressQuery,
    GetProfilesByAddressQueryVariables
  >(GetProfilesByAddressDocument, options);
}
export function useGetProfilesByAddressLazyQuery(
...
export type GetProfilesByAddressQueryHookResult = ReturnType<
  typeof useGetProfilesByAddressQuery
>;
export type GetProfilesByAddressLazyQueryHookResult = ReturnType<
  typeof useGetProfilesByAddressLazyQuery
>;
export type GetProfilesByAddressQueryResult = Apollo.QueryResult<
  GetProfilesByAddressQuery,
  GetProfilesByAddressQueryVariables
>;
export const GetDefaultProfileDocument = gql`
...
/**
 * __useGetDefaultProfileQuery__
 *
 * To run a query within a React component, call `useGetDefaultProfileQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetDefaultProfileQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useGetDefaultProfileQuery(
  baseOptions: Apollo.QueryHookOptions<
  ...
  return Apollo.useQuery<
    GetDefaultProfileQuery,
    GetDefaultProfileQueryVariables
  >(GetDefaultProfileDocument, options);
}
export function useGetDefaultProfileLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetDefaultProfileQuery,
    GetDefaultProfileQueryVariables
  >
...
export type GetDefaultProfileQueryHookResult = ReturnType<
  typeof useGetDefaultProfileQuery
>;
export type GetDefaultProfileLazyQueryHookResult = ReturnType<
  typeof useGetDefaultProfileLazyQuery
>;
export type GetDefaultProfileQueryResult = Apollo.QueryResult<
  GetDefaultProfileQuery,
  GetDefaultProfileQueryVariables
>;
...
export function useGetProfileByHandleQuery(
  ...
  return Apollo.useQuery<
    GetProfileByHandleQuery,
    GetProfileByHandleQueryVariables
  >(GetProfileByHandleDocument, options);
}
...
export type GetProfileByHandleQueryHookResult = ReturnType<
  typeof useGetProfileByHandleQuery
>;
...
export type AuthenticateMutationOptions = Apollo.BaseMutationOptions<
  ...
  AuthenticateMutationVariables
>;
export const RefreshAuthenticationDocument = gql`
...
`;
export type RefreshAuthenticationMutationFn = Apollo.MutationFunction<
  RefreshAuthenticationMutation,
  RefreshAuthenticationMutationVariables
>;

/**
 * __useRefreshAuthenticationMutation__
 *
 * To run a mutation, you first call `useRefreshAuthenticationMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useRefreshAuthenticationMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [refreshAuthenticationMutation, { data, loading, error }] = useRefreshAuthenticationMutation({
 *   variables: {
 *      refreshToken: // value for 'refreshToken'
 *   },
 * });
 */
export function useRefreshAuthenticationMutation(
  baseOptions?: Apollo.MutationHookOptions<
    RefreshAuthenticationMutation,
    RefreshAuthenticationMutationVariables
  >
  ...
  return Apollo.useMutation<
    RefreshAuthenticationMutation,
    RefreshAuthenticationMutationVariables
  >(RefreshAuthenticationDocument, options);
}
export type RefreshAuthenticationMutationHookResult = ReturnType<
  typeof useRefreshAuthenticationMutation
>;
export type RefreshAuthenticationMutationResult =
  Apollo.MutationResult<RefreshAuthenticationMutation>;
export type RefreshAuthenticationMutationOptions = Apollo.BaseMutationOptions<
  RefreshAuthenticationMutation,
  RefreshAuthenticationMutationVariables
>;
